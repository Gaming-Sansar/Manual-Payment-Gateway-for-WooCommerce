...
class MPG_Admin {
    ...
    public function payment_logs_page() {
        ...
        if (isset($_POST['update_status']) && wp_verify_nonce($_POST['mpg_nonce'], 'mpg_update_status')) {
            ...
            echo '<div class="notice notice-success"><p>' . __('Status updated successfully.', 'manual-payment-gateway') . '</p></div>';
        }
            ...
            <table class="wp-list-table widefat fixed striped">
                <thead>
                    <tr>
                        ...
                        <th><?php _e('Status', 'manual-payment-gateway'); ?></th>
    ...
    public function update_payment_status() {
        ...
        if ($result !== false) {
            wp_send_json_success(array('message' => __('Status updated successfully.', 'manual-payment-gateway')));
        } else {
